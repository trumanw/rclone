...
You can also find a [mirror of the downloads on github](https://github.com/trumanw/rclone/releases/tag/{{< version >}}).
...
log](https://github.com/trumanw/rclone/commits/master).  The most recent
